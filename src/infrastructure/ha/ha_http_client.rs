...
mod tests {
    ...
    fn base_config() -> AppConfig {
        AppConfig {
            ...
            solar_buffer_top_entity_id: "".to_string(),
            solar_buffer_bottom_entity_id: "".to_string(),
            solar_flow_entity_id: "".to_string(),
            solar_return_entity_id: "".to_string(),
            solar_pump_entity_id: "".to_string(),
